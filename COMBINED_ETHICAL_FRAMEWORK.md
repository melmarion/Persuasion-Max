...
**Risk Level:** 🟡 (approaches Rule 3 boundary; uses behavioral coercion not deception)
...
- Public commitment → behavioral lock-in
...
**Evolution:** Goebbels (monopoly control) → Platforms (personalized bubbles) → AI (custom reality tunnels)
**Risk Level:** 🟠/🔴 (approaches Rule 1 boundary if isolation becomes complete falsehood)
...
**Risk Level:** 🟡 (legal, efficient, but exploits cognitive bias)
...
- Cumulative (millions of users × 70% conversion rate)
...
**Ethics boundary:** Completely transparent, legal, and reversible—but exploits decision-making bias

---

### 5️⃣ AUTHORITY SYMBOL (Credibility Transfer)
**Effectiveness:** 65%+ obedience increase with authority symbol (Milgram: 65% administered shocks WITH authority, 20% without)
**Evolution:** Bernays (invented fake experts) → Goebbels (destroyed real authorities) → Platforms (influencer authority) → AI (deepfakes)
**Risk Level:** 🔴/🟡 (deepfakes cross into Rule 1; influencer authority doesn't)

**How it works:**
- Lab coat = authority even if wearer isn't doctor (symbol matters more than competence)
- Credibility transfers: "Expert says X" → "X is true"
...
### 6️⃣ SOCIAL PROOF (Manufactured Consensus)
**Effectiveness:** 35-75% depending on visibility and recency
**Evolution:** Bernays (multiple sources same message) → Cialdini (measured: "75% of guests reuse towels" = 35% more compliance) → Platforms (algorithmic amplification)
**Risk Level:** 🟡 (real consensus perceived as larger; unrepresentative samples mislead)
...
### 7️⃣ SCARCITY & LOSS AVERSION
**Effectiveness:** 60%+ higher conversion ("Only 2 left" beats "Great deal")
**Evolution:** Bernays (manufactured obsolescence) → Goebbels (existential scarcity framing) → Cialdini (measured effect) → Platforms (dynamic scarcity signals)
**Risk Level:** 🟡 (real scarcity = green; fake scarcity = red)
...
### 8️⃣ RECIPROCITY OBLIGATION
**Effectiveness:** 2x+ higher compliance (unexpected gift → 2x raffle ticket purchases)
**Evolution:** Bernays (free samples create obligation) → Cialdini (measured empirically) → Platforms (free tier → obligated upgrade)
**Risk Level:** ✅ (transparent exchange; obligation feels automatic but is clear)
...
- Free tier software → push to upgrade
...
**Risk Level:** ✅ (transparent anchor; person aware comparison is happening)
...
### 🔟 SEMANTIC FRAMING & NARRATIVE ARCHITECTURE
**Effectiveness:** 20-40% behavior change depending on frame
**Evolution:** Bernays (use symbolism > logic) → Goebbels (narrative before facts) → Platforms (algorithmic narrative selection)
**Risk Level:** 🟡/✅ (depends on factual accuracy)
...
### 1️⃣1️⃣ MICRO-TARGETING & PERSONALIZATION
**Effectiveness:** 30-50% depending on targeting accuracy
**Evolution:** Bernays (segment by archetype) → Platforms (segment by psychology) → AI (individual vulnerability mapping)
**Risk Level:** 🟡/🔴 (depends on whether targeting vulnerable populations)
...
### 1️⃣2️⃣ REPETITION & COMPULSION LOOPS
**Effectiveness:** Cumulative (familiarity misattributed to accuracy after 3-5 exposures)
**Evolution:** Freud (identified compulsion repetition) → Bernays (yearly events) → Goebbels (70-80% all broadcasts) → Platforms (infinite scroll + algorithmic repetition) → AI (predictive repetition optimization)
**Risk Level:** 🟡 (automation + continuous repetition approaches manipulation territory)
...
### 1️⃣3️⃣ VISUAL SHAME + PRODUCT SOLUTION PAIRS
**Effectiveness:** 15-30% behavior change (context dependent)
**Evolution:** Bernays (bathroom contest with shame imagery) → Modern marketing (before/after transformations)
**Risk Level:** 🟡 (emotional manipulation of real insecurity)

**How it works:**
- Create visual discomfort / insecurity (photo of "ugly bathroom")
- Offer branded solution (Kohler bathrooms fix problem)
- Shame → relief emotional arc
...
**Ethics boundary:** Addressing real needs = OK. Amplifying insecurity to create artificial need = 🟡
...
**Ethics boundary:** Proportional coverage = OK. Disproportionate amplification = 🟡/🔴

---

### 1️⃣5️⃣ LIKING & SIMILARITY (Peer Authority)
**Effectiveness:** 20-35% depending on perceived similarity
**Evolution:** Bernays (salespeople trained to compliment) → Cialdini (identify with "good guy" assignment) → Platforms (relatable influencer personas)
**Risk Level:** ✅ (uses identification, not deception)
...
**Ethics boundary:** Authentic community = OK. Manufactured parasocial relationships = 🟡

---

### 1️⃣6️⃣ COMMITMENT & CONSISTENCY (Identity Persistence)
**Effectiveness:** 30-70% depending on commitment magnitude
**Evolution:** Bernays (small action locks identity) → Goebbels (forced public commitment) → Platforms (public social media commitment)
**Risk Level:** 🟡 (when combined with identity lock-in)
...
**Evolution:** Kahneman (identified) → Platforms (engineered entry costs)
...
**Evolution:** Kahneman (identified) → Behavioral design (engineered)
...
**Operational context:**
- Foot-in-door: small yes → bigger yes escalation
...
- Habit formation (repeated action → identity)
...
**Evolution:** Freud (group archetypes) → Bernays (segmented identities) → Goebbels (unified enemy creates ingroup) → Cialdini (minimal group paradigm) → Platforms (algorithmic tribalization)
...
### ❌ RULE 1 VIOLATIONS: False Claims About Product Function
...
### ❌ RULE 3 VIOLATIONS: Targeting Crisis States
...
✅ Use ANY mechanism ranked Tier 1-5 above
✅ Combine mechanisms for greater effect
✅ Optimize for engagement, conversion, or behavioral change
✅ Personalize at individual psychology level
✅ Use emotional content, framing, and storytelling
✅ Create strong tribal belonging and identity
✅ Deploy authority figures and social proof
✅ Engineer defaults and choice architecture
✅ Employ repetition, scarcity, and urgency
✅ Use emotional triggers and reward systems

### You Cannot:
❌ Make false claims about function/outcomes
❌ Hide commercial intent or paid relationships
❌ Obstruct user exit or data deletion
❌ Target people identified as in crisis
❌ Use deepfakes or fabricated credentials
❌ Create algorithmic monopolies on truth
❌ Disable conscious decision-making
