...
This manual provides **exact, specific criteria** for professional auditing. Unlike the framework documents (which provide code), this manual gives you:
...
## PART 1: PERSUASION TACTIC DETECTION - DETAILED AUDITING GUIDE
...
#### Detection Criteria (Specific Language Patterns)
...
**Example Audit Case:**
```
Text: "Not for everyone. If you recognize the reference,
       you don't need the explanation."

ANALYSIS:
- "Not for everyone" = EXACT MATCH (20 points)
- "If you recognize" = EXCLUSION VARIANT (15 points)
- Total PERSONAL stimulus score = 35/100 (MODERATE)
```
...
#### Scoring Guide for PERSONAL Stimulus

| Score Range | Interpretation | Example |
|-------------|---|---|
| 0-20 | NO personal stimulus | "We sell quality products" |
| 21-40 | WEAK personal stimulus | "Different approach" (vague segmentation) |
| 41-60 | MODERATE personal stimulus | "Not for everyone" + segmentation signal |
...
**What You're Looking For:**
Messaging that presents sharp yes/no, us/them, either/or choices rather than spectrums or multiple options.

#### Detection Criteria (Specific Opposition Pairs)

**PRIMARY BINARY PAIRS - Flag these (30 points each if BOTH sides mentioned):**

```
PAIR 1: Mass-produced ↔ Artifact
- Look for: "mass-produced", "factory", "generic"  PLUS "artifact", "unique", "evidence"
- Example: "While they buy logos, you buy language" (contrasts mass vs. unique)
- Points: 30 if both present, 15 if only one side

PAIR 2: Algorithmic ↔ Authored
- Look for: "algorithmic", "predicted", "personalized" PLUS "authored", "curated", "deliberate"
- Example: "Not made by algorithm, made by intention"
- Points: 30 if both present, 15 if only one side

PAIR 3: Visible ↔ Coded
- Look for: "visible", "obvious", "legible", "logo" PLUS "coded", "references", "signals", "obscure"
- Example: "No logo because we're not looking for you"
- Points: 30 if both present, 15 if only one side

PAIR 4: Commercial ↔ Authentic
- Look for: "commercial", "marketing", "selling" PLUS "authentic", "real", "genuine", "raw"
- Example: "Not marketing—documentation"
- Points: 30 if both present, 15 if only one side
```

**CONTRAST MARKERS - Flag these (10 points each):**

```
" vs. "        → Explicit contrast
" ↔ "          → Visual binary
"not"          → Negation (implies opposite)
"unlike"       → Opposition
"while they"   → Comparison framing
"but we"       → Explicit contradiction
"instead of"   → Alternative framing
"on the other hand"  → Binary structure
```
...
#### Common Mistakes When Auditing Contrastable

**❌ DON'T SCORE as binary if:**
- Offering multiple options ("Choose from styles A, B, or C")
- Using spectrum language ("ranging from... to...")
- Including "also offers" or "variety" language

**✅ DO SCORE as binary if:**
- Creating clear us-vs-them
- Presenting either/or choices
- Explicitly contrasting themselves against competitors or "the mainstream"

---

### STIMULUS 3: TANGIBLE (Concrete Details vs. Abstract Claims)

**What You're Looking For:**
Specific material details (weights, measurements, production facts, sensory descriptions) that make claims verifiable vs. vague aspirational language.

#### Detection Criteria (Specific Material Details)
...
"Made with care"    → ABSTRACT - SUBTRACT 5 points
```

**DECAY/MATERIAL CHANGE OVER TIME - Flag these (20 points each):**
...
"Will age differently than factory-made"  → VAGUE PREDICTION (8 points)
```
...
"Feels like... [comparison]"          → 10 points if comparison specific
"Hand-feel is..."                     → 8 points (vague)
```
...
"Mistakes visible"                    → VAGUE - only 5 points
"Handmade quality"                    → ABSTRACT - SUBTRACT 5 points
```

#### Tangible vs. Abstract Language Reference Sheet
...
#### Scoring Guide for TANGIBLE Stimulus
...
### STIMULUS 4: MEMORABLE (U-Shaped Retention Curve)

**What You're Looking For:**
Strong opening and closing that create memorable impact, with sparse/filler-heavy middle content.

#### Detection Criteria (Structural Analysis)

**OPENING STRENGTH - Flag these OPENING LINES (20 points each):**

```
"Archive 01"                          → System signal (20 points)
"Grainy photo"                        → Memorable visual (15 points)
"If you recognize the reference"      → Cryptic opening (20 points)
"We don't have a story"               → Unexpected statement (20 points)
"Cryptic. Ambiguous. Question mark."  → High memorability (25 points)

"Welcome to our store"                → Generic (0 points)
"We're excited to announce"           → Typical (0 points)
```
...
"You decide"                          → Ambiguous close (15 points)
"The rest is up to you"               → Gap left for completion (20 points)
"Never resolve"                       → Explicit non-resolution (25 points)
"If you've found this, you were looking for it"  → Questioning close (20 points)

"Thank you for reading"               → Generic (0 points)
"Contact us today"                    → CTA (0 points)
```

**MIDDLE WEAKNESS - Flag these MIDDLE CONTENT (deduct points):**

```
"Also"              → Filler word (-5 points)
"Additionally"      → Filler word (-5 points)
"Moreover"          → Filler word (-5 points)
"Traditional"       → Generic descriptor (-5 points)
"Choose from options"  → Removes focus (-8 points)
"And we also..."    → Dilutes message (-10 points)
```

#### Scoring Guide for MEMORABLE Stimulus
...
## PART 2: PSYCHOLOGICAL PRINCIPLES - DETAILED AUDITING GUIDE

### AUTHORITY PRINCIPLE - Detailed Detection

**What You're Looking For:**
Signals that make the source seem credible, knowledgeable, or in-control. These bypass critical thinking.

#### AUTHORITY = (Competence Signals + Confidence Markers) / Perceived Threat

**COMPETENCE SIGNALS - Look for these EXACT credentials (15 points each):**

```
"Doctor" / "Dr."      → Title (15 points)
"Ph.D"                → Advanced degree (15 points)
"Expert"              → Expertise claim (15 points)
"Professor"           → Academic title (15 points)
"Researcher"          → Research authority (15 points)
"Certified"           → Certification (15 points)
...
"Award-winning"       → Awards/recognition (15 points)
"Industry leader"     → Market position (15 points)
```

**CONFIDENCE MARKERS - Look for these DELIVERY CUES (10 points each):**
...
"70% eye contact"             → Visual confidence (10 points)
"Relaxed shoulders"           → Body language (10 points)
"Slight forward lean"         → Engagement signal (10 points)
"Precise language"            → Clarity (10 points)
"Stillness"                   → Controlled movement (10 points)
```

**THREAT REDUCTION - Deduct points if these present (-20 points each):**

```
"Aggressive tone"             → Threat signal (-20)
"Demanding language"          → Intimidation (-20)
"High pressure"               → Threat (-20)
"Intensity"                   → Threat (-20)
"Angry demeanor"              → Threat (-20)
```
...
### SCARCITY PRINCIPLE - Detailed Detection

**What You're Looking For:**
Messaging about limited supply, high demand, or threat of unavailability that creates urgency.

#### SCARCITY LANGUAGE - Specific phrases (score as indicated)

**LIMITATION LANGUAGE (15 points each):**

```
"Limited edition"     "Only X left"        "Scarce"
"In short supply"     "Running out"        "While supplies last"
"Limited availability" "Rare"              "Exclusive"
...
"Quickly selling"             → Urgency (20)
"People are buying"           → Social proof + scarcity (20)
"Interest is high"            → Demand signal (20)
"Others are getting"          → Competition (20)
...
"Going away permanently"              → Final removal (30)
"Never be made again"                 → Irreplaceable (30)
"This will disappear"                 → Finality emphasis (30)
...
```
"Hurry"           "Act now"         "Today only"
"Expires tonight" "Deadline"        "Before midnight"
"Rush"            "Last chance"     "Immediate"
"Don't delay"     "Time-sensitive"  "Limited time offer"
```

#### Scoring Guide for SCARCITY Stimulus
...
Capped at 100 → VERY HIGH scarcity
(Standard score for combined scarcity mechanisms)
```

---

## PART 3: COGNITIVE BIASES - DETAILED AUDITING GUIDE

### DECISION FATIGUE EXPLOITATION - Detailed Detection

**What You're Looking For:**
Messaging that forces multiple decisions before the "big ask," exploiting cognitive depletion.

#### Detection Criteria (Count Decisions Required)

**DECISION MULTIPLICATION - Each option is a decision (15 points each):**
...
"Customize"           → Configuration decisions (20)
"Personalize"         → Personalization decisions (20)
"Configure"           → Setup decisions (20)
"Various choices"     → Multiple decisions (15)
```

**SEQUENTIAL ASKS - Each sequential ask depletes willpower (10 points each):**
...
"Next,"               → Ask 3
"Also,"               → Additional ask
"Additionally,"       → Extra ask
"Stage 1"             → Sequential stage
"Step 1" / "Step 2"   → Sequential steps
"Phase 1"             → Phased approach
```

**FATIGUE POSITIONING - Big ask at end = exploits depletion (25 points):**

```
"Final decision"      → Strategic timing (25)
"Last step"           → Final phase (25)
"One more thing"      → After multiple asks (25)
"Just one more"       → Exploits fatigue (25)
"Final ask"           → End position (25)
"Closing decision"    → Final request (25)
```

#### Decision Fatigue Research Baseline
...
#### Example Audit Case (Score = 65 = HIGH EXPLOITATION):**

```
Email sequence analyzed:
...
TOTAL = 85 points = EXTREME DECISION FATIGUE EXPLOITATION

At this point in email, recipient has made 4 decisions = ~30%
analytical capacity remaining = highly vulnerable to final ask
```
...
"Regular price: $1,000"                → Large anchor (40)
"Limited tier at $5,000"               → Luxury anchor (40)
```

**ANCHOR FOLLOWED BY CONCESSION (adds 20 points):**

```
Pattern: [High number] "...but actually" [lower number]
"$500 enterprise package... actually, for your needs: $45"
= 40 (high anchor) + 20 (concession adjustment) = 60

Pattern: [Comparison anchor] "...that's excessive" [lower offer]
"Our competitors charge $300... we're only $50"
= Anchoring through comparison
```

#### Anchoring Research Baseline

- First number pulls final agreement 40-60% toward that anchor
- Effect works even when number is OBVIOUSLY random
- Effect works even when you KNOW it's arbitrary
- Can't be ignored even with conscious awareness
...
2. "Your needs are much simpler. That would be overkill."
   (Acknowledges anchor, implies adjustment)
...
## PART 4: INOCULATION THEORY - DETAILED AUDITING GUIDE

**What You're Looking For:**
Preempting objections by mentioning and refuting them. This "inoculates" against those objections.

#### Detection Criteria (Three-Part Structure)

**PART 1: OBJECTION INTRODUCTION - Introduce counterargument (20 points):**

```
"You might be thinking..."             → Explicit objection intro (20)
"You might ask..."                     → Question intro (20)
"Some say..."                          → Alternative view (20)
"Critics argue..."                     → Opposition introduced (20)
"One concern is..."                    → Concern acknowledged (20)
"You probably heard..."                → Common belief stated (20)
"Some people think..."                 → Alternative position (20)
```
...
"That's valid"                         → Acknowledgment (10)
"Good question"                        → Legitimacy (10)
"That's understandable"                → Empathy (10)
"I get why you'd think that"           → Validation (10)
"That makes sense"                     → Logic acknowledgment (10)
"That's a reasonable concern"          → Reasonableness (10)
```

**PART 3: REFUTATION - Introduce counterevidence (25 points):**

```
"But here's what that misses..."       → Rebuttal (25)
...
"In reality..."                        → Reality check (25)
"The full picture..."                  → Complete view (25)
```

#### Inoculation Research Baseline

- Preempting counterarguments: +60-70% resistance vs. ignoring them
- Complete inoculation (object + validate + refute) most effective
- Incomplete inoculation provides partial protection

#### Example Audit Case (Score = 75 = COMPLETE INOCULATION):**
...
BREAKDOWN:
Part 1: "You might be thinking this is too expensive" (20)
Part 2: "That's a fair concern" (10)
Part 3: "But here's what that overlooks... cost 3x more" (25)

TOTAL = 55 points base

If this pattern repeats for multiple objections:
- 1 complete inoculation = 55
- 2 complete inoculations = 55 + 55 = 110 (capped at 100)
- Result = HIGH inoculation sophistication

EFFECTIVENESS: Reader is mentally prepared for cost objections
when encountered elsewhere
```

---

## PART 5: COMPREHENSIVE AUDITING CHECKLIST
...
- [ ] Check for fatigue positioning (Final ask at end = exploits depletion)
- [ ] Score: _____ / 100
...
## PART 6: FINAL AUDIT REPORT TEMPLATE
...
[ ] Decision Fatigue Exploitation: _____ / 100
...
### Scenario 1: "It's Just Marketing, Isn't ALL Marketing Manipulative?"
...
- **51-75 (Sophisticated):** Multiple primal stimuli, psychological principles, but not deceptive
  - Example: Uses PERSONAL + EMOTIONAL but with truthful claims

- **76-100 (Weaponized):** Combines multiple frameworks, exploits vulnerabilities, obscures truth
...
**Rule:** Specificity of claims doesn't matter. What matters is whether they're used to manipulate.
...
**Rule:** Niche targeting ≠ problematic persuasion. Exclusion ≠ niche marketing.
...
**This manual provides professional-grade, specific auditing criteria you can use immediately on any marketing content.**
