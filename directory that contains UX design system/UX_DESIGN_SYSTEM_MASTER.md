...
|--------|---------|-------------|
| **`index.js`** | **MAIN ENTRY POINT** | **All consolidated exports - import from here** |
...
| **`uxEngagementPatterns.js`** | **[NEW]** P1-P12 engagement specs | P1-P12 constants, user responsiveness, metrics |
| **`uxSessionDesign.js`** | **[NEW]** Session architecture | 11-min phases, event timestamps, hooks |
| **`uxNeuroAesthetic.js`** | **[NEW]** Sensory design specs | Colors, audio frequencies, haptic, environmental |
...
1. **Always import from main entry point** (`index.js`) for convenience
