...
1. `01_TOOLS_YOU_CAN_BUILD.md` - Overview of all 12 tools
2. `CODE/04_PRODUCTION_CODE_BASE.md` - Tools 1-3 (start here)
3. `DETECTION/17_MACHINE_READABLE_DETECTION_SYSTEM.md` - Regex patterns & scoring

### I want to UNDERSTAND the patterns being detected
1. `DETECTION/11_TACTICAL_DETECTION_FRAMEWORK.md` - 6 stimulus detection
2. `DETECTION/12_PSYCHOLOGICAL_PRINCIPLES_DETECTION_FRAMEWORK.md` - Psychology patterns
3. `RESEARCH/19_REAL_WORLD_CASE_STUDIES_DETAILED.md` - Famous examples

### I want to see the RESEARCH foundation
1. `RESEARCH/FRACTIONATION_BEHAVIORAL_SCIENCE.md` - Core mechanism
2. `RESEARCH/FRACTIONATION_DETECTION_METHODS.md` - 14 measurement methods
3. `RESEARCH/EVOLUTION_ANALYSIS.md` - Historical progression
...
| 3 | `02_TOOL_SPECIFICATIONS.md` | Data schemas, APIs, algorithms |
| 4 | `DETECTION/17_MACHINE_READABLE_DETECTION_SYSTEM.md` | Regex + scoring rules |
| 5 | `EXECUTION/08_QUICK_START_CHECKLIST.md` | 48-hour setup guide |

---

## WHAT'S IN EACH DETECTION FILE
...
## WHAT'S IN EACH RESEARCH FILE

| File | Content |
|------|---------|
| `19_REAL_WORLD_CASE_STUDIES_DETAILED.md` | Bernays, Goebbels, modern brands with detection rules |
...
| `FRACTIONATION_DETECTION_METHODS.md` | 14 measurement methods + RCT designs |
