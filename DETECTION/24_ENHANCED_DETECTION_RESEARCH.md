...
- Anger-evoking material disproportionately includes misinformation and toxicity
...
## PART 2: DECEPTIVE DESIGN PATTERNS - ENHANCED DETECTION
...
| **14 State Privacy Laws** | Various US States | Deceptive design prohibitions |
...
Variable ratio reinforcement (VR) schedules are the most resistant to extinction and most associated with addictive behaviors. Research shows:

- Slot machines using VR schedules create **compulsive engagement**
- Same mechanics used in social media, gaming, and e-commerce
- Activates **dopamine pathways similarly to addictive substances**
