...
### DECISION FATIGUE APPLICATION - Detailed Detection

**What You're Looking For:**
Messaging that forces multiple decisions before the "big ask," leveraging cognitive depletion.
...
**FATIGUE POSITIONING - Big ask at end = leverages depletion (25 points):**
...
TOTAL = 85 points = EXTREME DECISION FATIGUE APPLICATION

At this point in email, recipient has made 4 decisions = ~30%
analytical capacity remaining = highly susceptible to final ask
```
